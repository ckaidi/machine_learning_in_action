...
fileTraining = 'DATA/AutoChessData/0.txt'
classLabel = {"1": "蜀国", "10a": "魔坦刺", "5e": "长城射", "ae": "坦射",
              "0d": "魏法", "b": "战士", "6c": "扶桑刺", "9e": "封神射"}
...
for i in testMat:
    dataTest[int(i)] += 1
result = classify0(dataTest, numpy.array(c), b, 8)
nums=[]
for i in range(8):
    nums.append(result[i][1])
    result[i] = classLabel[str(result[i][0])]
print(result)
print(nums)
